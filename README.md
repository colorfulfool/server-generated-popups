...
The screenshot above is from [Invoices for Milestones](http://invoicesformilestones.com), where this gem is extracted from. Invoices for Milestones is a dead simple invoicing tool for self-employed. If you work for yourself, check it out.
